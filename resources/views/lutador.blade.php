...
<body>
  ...
  <form class="form-floating"  action="{{route('enviar')}}" method="post" enctype="multipart/form-data" >
  @csrf  
    <div>
    ...
    <div>
      ...
      <textarea class="form-control" name="descricao" placeholder="Digite Uma Descrição" id="floatingTextarea"></textarea>
    </div>
